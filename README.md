...
Product Requirement Prompt (PRP) is a structured prompt methodology that supplies an AI coding agent with everything it needs to deliver working software. It combines:

- **Traditional PRD elements** (what to build, why)
- **Context** (file paths, library docs, code examples)
- **Implementation details** (how to build, patterns to follow)
